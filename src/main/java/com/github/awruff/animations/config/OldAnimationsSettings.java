package com.github.awruff.animations.config;
...
public class OldAnimationsSettings extends Config {
    ...
    @Switch(
            name = "1.7 Miss Penalty",
            description = "Removes the miss penalty, similar to 1.7.",
            subcategory = "Interaction"
    )
    public static boolean noMissPenalty = true;
    ...
    public OldAnimationsSettings() {
        super(new Mod(Animations.NAME, ModType.PVP), "overflowanimations.json");
        initialize();
